# -*- coding: latin-1 -*-
# Exemplo com persistência herdada de uma classe base.
# A classe base Persistente implementa salvar e carregar com pickle.
# A classe MinhaClasse herda Persistente e trabalha com uma lista de dados.
##########################################################################
# CLASSE BASE PARA PERSISTÊNCIA: COLOCAR NO PROGRAMA DO PjBL1.
# Esta classe implementa métodos de salvar e carregar dados usando o módulo
# pickle. Ela serve como classe base para outras classes que desejam ter
# persistência automática de seus dados em arquivos binários.
